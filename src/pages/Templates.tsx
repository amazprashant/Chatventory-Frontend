...
export default function Templates() {
  const [roleName, setRoleName] = useState("");
    ...
    const [isModalCustomEmailOpen, setModalCustomEmailOpen] = useState(false);
  ...
  return (
    <>
      ...
      <main id="main" className="main">
        ...
        <Modal isOpen={isModalCustomEmailOpen} onClose={() => setModalCustomEmailOpen(false)} title="Send Custom Email">
